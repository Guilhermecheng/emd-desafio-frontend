...
function App() {
  ...
  function modelInitPosition() {
    ...
    cameraControlRef.current?.rotateAzimuthTo( -12.6 * THREE.MathUtils.DEG2RAD, true );
  ...
  function modelChristZoom(direction) {
    if(direction > 0) {
      cameraControlRef.current.rotatePolarTo( 90 * THREE.MathUtils.DEG2RAD, true );
  ...
  return (
    ...
    >
      ...
      <section id="animation-section" className="flex w-full h-[100vh] items-center justify-center fixed top-0 left-0 -z-20 opacity-0">
          <Canvas
            dpr={[1, 1.5]} 
